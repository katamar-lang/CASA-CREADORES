...
const footerSections: { title: string; links: { title: string; href: string }[] }[] = [
  {
    title: "Producto",
    links: [
      { title: "Cómo funciona", href: "/#como-funciona" },
      { title: "Para marcas", href: "/registro?role=MARCA" },
      { title: "Para creadores", href: "/registro?role=CREADOR" },
  ...
  },
  {
    title: "Empresa",
    links: [
      { title: "Modelo de comisión", href: "/#modelo" },
      { title: "Contacto", href: "mailto:hola@casacreadores.com" },
    ],
  },
];
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-12 sm:grid-cols-4 lg:grid-cols-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out fill-mode-both">
              ...
              <a
                href="mailto:hola@casacreadores.com"
                className="text-sm text-muted-foreground transition-colors hover:text-foreground"
              >
                hola@casacreadores.com
              </a>
            </div>
          </div>
        </div>
