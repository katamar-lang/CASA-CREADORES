...
import { getContactEmail, getSocialLinks, type SocialLink } from "@/lib/site";
...
const footerSections: { title: string; links: { title: string; to: string }[] }[] = [
  {
    title: "Producto",
    links: [
      { title: "Cómo funciona", to: "/#como-funciona" },
      { title: "Para marcas", to: "/registro?role=MARCA" },
      { title: "Para creadores", to: "/registro?role=CREADOR" },
  ...
  },
  {
    title: "Empresa",
    links: [
      { title: "Modelo de comisión", to: "/#modelo" },
      ...
      <div className="container py-16">
        <div className="grid grid-cols-2 gap-x-8 gap-y-12 sm:grid-cols-4 lg:grid-cols-12">
          <div className="col-span-full lg:col-span-5">
            <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out fill-mode-both">
              <Logo />
              <p className="max-w-xs text-sm text-muted-foreground">
                Conectamos marcas de cripto y fintech con creadores hispanohablantes verificados en LATAM. Pagos en
                USDC, sin fricción bancaria.
              </p>
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out fill-mode-both">
              <p className="text-sm font-medium text-foreground">¿Hablamos?</p>
              {contactEmail ? (
                <a
                ...
                <Link to="/contacto" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                  Escríbenos
                </Link>
              )}
            </div>
        ...
        <p className="text-center text-xs text-muted-foreground animate-in fade-in duration-700 ease-out fill-mode-both">
          © {new Date().getFullYear()} Casa Creadores. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
